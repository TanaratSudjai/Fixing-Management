...
<body class="bg-gray-100 font-['Kanit']">
    ...
    @section('content')
        <div class="h-[92vh] flex items-center justify-center w-full px-4">
            <div class="bg-white shadow-md w-full max-w-md mx-auto px-4 py-8 flex flex-col">
                <!-- Repair Form -->
                <form action="{{ route('repairs.store') }}" method="POST" class="space-y-6">
                    ...
                    <header class="text-center mb-8">
                        <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold text-[#DC5F00] mb-2 transform hover:scale-105 transition duration-300 mt-4">
                    ...
                    <div>
                        ...
                        <textarea id="repair_detail" name="repair_detail" rows="4"
                            class="w-full px-3 py-2 text-[#373A40] border border-[#686D76] rounded-lg focus:outline-none focus:border-[#DC5F00] transition duration-300"
                            required></textarea>
                    </div>
