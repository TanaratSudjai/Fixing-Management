    ...
    @section('content')
        <div class="container mx-auto px-4 py-8">
            <header class="text-center mb-8">
                <h1 class="text-4xl font-bold text-[#DC5F00] mb-2 transform hover:scale-105 transition duration-300">
                    แจ้งซ่อมสำหรับลูกค้า</h1>
            </header>
                ...
                <form action="{{ route('repairs.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="repair_detail"
                            class="block text-sm font-medium text-[#686D76] mb-2">รายละเอียดการซ่อม</label>
                        <textarea id="repair_detail" name="repair_detail" rows="4"
                            class="w-full h-[40vh] px-3 py-2 text-[#373A40] border border-[#686D76] rounded-lg focus:outline-none focus:border-[#DC5F00] transition duration-300"
                            required></textarea>
                    </div>
                    <button type="submit"
