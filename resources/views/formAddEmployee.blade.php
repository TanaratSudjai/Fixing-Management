        ...
        <div class="flex items-center justify-center min-h-screen px-4 py-12 sm:px-6 lg:px-8 mt-[-100px]">
            <div class="p-6 sm:p-8 rounded-2xl bg-white shadow-xl w-full max-w-md">
                ...
                <form id="employee-form" action="{{ route('admin.addEmployee') }}" method="POST" class="mt-6 space-y-4" >
                    ...
                    <div>
                        <label class="text-gray-800 text-sm mb-2 block">Comfirm Password</label>
                        <div class="relative flex items-center">
                    ...
                    <button id="submit-btn" type="submit" class="w-full py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-blue-400 hover:bg-blue-500 focus:outline-none">Add Employee</button>
                </form>
            </div>
        </div>
