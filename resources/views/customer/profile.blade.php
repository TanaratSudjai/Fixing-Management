...
<body>
    ...
    @section('content')
        <div class="bg-gray-100 min-h-screen overflow-x-auto">

            <div class="bg-cover bg-center h-40 sm:h-56 bg-gray-300"></div>
            ...
            <div class="px-4 sm:px-6 lg:px-8 mt-8 max-h-screen overflow-y-auto scrollbar">
                <div class="rounded-lg p-6 max-w-3xl mx-auto bg-[#EEEEEE] shadow-lg">
                    ...
                    <ul class="text-gray-700 space-y-3 flex flex-col gap-5">
                        <li class="flex items-center justify-between shadow-md p-5 bg-[#FF6F00] text-white rounded">
                            <strong class="w-1/2 text-white">รอการตอบรับ</strong>
                            <span>{{ $countRepair_pending }}</span>
                        </li>
                        <li class="flex items-center justify-between shadow-md p-5 bg-[#DC5F00] text-white rounded">
                            <strong class="w-1/2 text-white">กำลังดำเนินการ:</strong>
                            <span>{{ $countRepair_inprogress }}</span>
                        </li>
                        <li class="flex items-center justify-between shadow-md p-5 bg-[#686D76] text-white rounded">
