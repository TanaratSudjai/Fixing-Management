  ...
  <nav class="bg-[#E1F7F5] ">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        ...
        @endif
            ...
            <a href="{{ route('logout') }}" class="text-black ml-auto hover:text-[#FF0000]" role="menuitem"
    ...
    <div class="sm:hidden hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2">
        ...
        <a href="{{ route('customer.dashboard') }}"
          class="block rounded-md px-3 py-2 text-base font-medium text-black hover:bg-gray-700 hover:text-white">แจ้งซ่อม</a>
        <a href="{{ route('repairs.list') }}"
