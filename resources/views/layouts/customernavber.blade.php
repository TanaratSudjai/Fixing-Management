        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div class="relative flex h-16 items-center justify-between">
                <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                    <button type="button"
                        class="relative inline-flex items-center justify-center rounded-md p-2 text-[#686D76] hover:bg-[#DC5F00] hover:text-[#EEEEEE] focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#373A40]"
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="flex flex-shrink-0 items-center">
                        <img src="{{asset('images/logoo.')}}" alt="Logo" class="w-10 h-8" alt="Your Company">
                    </div>
                    ...
                    <div class="relative flex justify-between items-center ml-3 gap-3">
                        <div>
                            <div class="relative flex rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-[#EEEEEE] focus:ring-offset-2 focus:ring-offset-[#686D76]"
                                ...
                                @if (session('message'))
                                    <div class="alert alert-success text-[#EEEEEE]">
