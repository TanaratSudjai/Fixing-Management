    ...
    <nav class="bg-[#E1F7F5] ">
        ...
        <div class="sm:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pb-3 pt-2">
                ...
                <a href="{{ route('active') }}" class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white"
                    aria-current="page">Dashboard</a>
                <a href="{{ route('customer.repir') }}"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">รายการแจ้งซ่อม</a>
                <a href="{{ route('employee.add') }}"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">เพิ่มพนักงาน</a>
                <a href="{{ route('product.add') }}"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">เพิ่มสินค้า</a>
                <a href="{{ route('products.view') }}"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">รายการสินค้า</a>
                <a href="{{ route('employee.list') }}"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">รายชื่อพนักงาน</a>
            </div>
        </div>
    </nav>
</body>
