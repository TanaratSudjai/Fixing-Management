...
<body class="bg-gray-100 flex justify-center items-center min-h-screen p-6">
    <div class="bg-white shadow-2xl rounded-xl p-8 w-full max-w-md mx-auto px-6 py-12">
        ...
        <div class="flex items-center justify-center w-full">
            <div class="flex items-center justify-center w-[150px]">
                <p class="w-full text-gray-600 mt-6 flex justify-between text-xs sm:text-sm">ยังไม่มีบัญชี?  <a href="/register" class="text-xs sm:text-sm hover:underline">สมัครสมาชิก</a></p>
            </div>
        </div>
    </div>
    @if ($errors->any())
